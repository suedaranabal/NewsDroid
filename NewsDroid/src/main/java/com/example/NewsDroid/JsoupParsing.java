...
//		JsoupConnect connectScience = new JsoupConnect("http://www.webtekno.com/haber",
...
//
//		JsoupConnect connectAgenda = new JsoupConnect("http://www.sozcu.com.tr/kategori/gundem/",
...
//
//		JsoupConnect connectSports = new JsoupConnect("http://www.karar.com/spor-haberleri", "div[class=\"body\"]>a");
//		connectSports.parseOperations("Sports/Sport", "http://www.karar.com", "data-original");
//
//		JsoupConnect connectGallery = new JsoupConnect("http://www.nationalgeographic.com.tr/kategori/fotograf/5",
//				"section[class=\"visualArticles big gest articlelinks\"]>div>div>img");
//		connectGallery.gallery("Gallery/Gallery");
//
//		JsoupConnect connectCinema = new JsoupConnect("http://www.istanbul.net.tr/sinema-filmler-vizyondakiler-1/",
